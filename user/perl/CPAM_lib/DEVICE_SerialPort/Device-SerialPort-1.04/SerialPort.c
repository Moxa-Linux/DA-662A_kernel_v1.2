 ...
 * contents of SerialPort.xs. Do not edit this file, edit SerialPort.xs instead.
 *
 *	ANY CHANGES MADE HERE WILL BE LOST! 
 *
 */

#line 1 "SerialPort.xs"
#include "EXTERN.h"
#include "perl.h"
#include "XSUB.h"
...
#line 95 "SerialPort.c"

XS(XS_Device__SerialPort__Bits_get_hash); /* prototype to pass -Wmissing-prototypes */
XS(XS_Device__SerialPort__Bits_get_hash)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 47 "SerialPort.xs"
	HV *	hv;
	char *	key;
	SV *	value;
#line 112 "SerialPort.c"
	SV *	RETVAL;
#line 52 "SerialPort.xs"
	/* initialize the hash */
	hv = newHV();
#ifdef _SC_CLK_TCK
...
extern "C"
#endif
XS(boot_Device__SerialPort); /* prototype to pass -Wmissing-prototypes */
XS(boot_Device__SerialPort)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXSproto("Device::SerialPort::Bits::get_hash", XS_Device__SerialPort__Bits_get_hash, file, "");
    if (PL_unitcheckav)
