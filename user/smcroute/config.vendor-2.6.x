...
CONFIG_LIB_XML2_FORCE=y
CONFIG_LIB_GD_FORCE=y
CONFIG_LIB_LIBPNG_FORCE=y
CONFIG_LIB_LIBJPEG_FORCE=y
CONFIG_LIB_REDBOOT_CONFIG=y
CONFIG_LIB_ICONV=y
...
# CONFIG_USER_NFS_UTILS is not set
...
CONFIG_USER_READY_LED=y
# CONFIG_USER_MX_SMG1100 is not set
# CONFIG_USER_LIBSMS is not set
CONFIG_USER_REPORTIP=y
# CONFIG_USER_MOXABURN is not set
CONFIG_USER_MOXABURN_UC8400=y
# CONFIG_USER_MXMPTEST is not set
CONFIG_USER_MXMPTEST_UC8400=y
...
# CONFIG_USER_UPFIRM is not set
CONFIG_USER_UPGRADEHFM=y
CONFIG_USER_BACKUPHFM=y
...
CONFIG_USER_TINYLOGIN_SECURETTY=y
