/* $Id: win32_service.c,v 1.5 2003/03/14 08:28:55 chris_reid Exp $ */
/*
...
#include <shlwapi.h> /* for Windows shell */
...
int SnortServiceMain(int argc, char* argv[]) 
{
    ...
    for( i=1; i<argc; i++ )
    {
        ...
        {
            /* ignore it, because we already know that this is a service
        ...
        {
            break;  /* out of for() */
            /* FatalError("ABORTING, unknown option: '%s'\n", argv[i]); */
            /* exit(0); */
        }
    }
