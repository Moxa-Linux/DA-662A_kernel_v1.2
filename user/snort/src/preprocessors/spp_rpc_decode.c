...
/* $Id: spp_rpc_decode.c,v 1.27 2003/03/26 21:59:48 chrisgreen Exp $ */
/* spp_rpc_decode 
 * 
 * Purpose:
 *
...
void PreprocRpcDecode(Packet *p)
{
    ...
    if(ret != 0)
    {
        ...
        case RPC_FRAG_TRAFFIC:
            ...
            {
                SetEvent(&event, GENERATOR_SPP_RPC_DECODE, RPC_FRAG_TRAFFIC, 1, RPC_CLASS, 3, 0);
        ...
        case RPC_MULTIPLE_RECORD:
            ...
            {
                SetEvent(&event, GENERATOR_SPP_RPC_DECODE, RPC_MULTIPLE_RECORD, 1, RPC_CLASS, 3, 0);
                CallAlertFuncs(p, RPC_MULTIPLE_RECORD_STR, NULL, &event);
        ...
        case RPC_LARGE_FRAGSIZE:
            ...
            {
                SetEvent(&event, GENERATOR_SPP_RPC_DECODE, RPC_LARGE_FRAGSIZE, 1, RPC_CLASS, 3, 0);
        ...
        case RPC_INCOMPLETE_SEGMENT:
            ...
            {
                SetEvent(&event, GENERATOR_SPP_RPC_DECODE, RPC_INCOMPLETE_SEGMENT, 1, RPC_CLASS, 3, 0);
                CallAlertFuncs(p, RPC_INCOMPLETE_SEGMENT_STR, NULL, &event);
                CallLogFuncs(p, RPC_INCOMPLETE_SEGMENT_STR, NULL, &event);
                DisableDetect(p);
            }
            break;
        }
