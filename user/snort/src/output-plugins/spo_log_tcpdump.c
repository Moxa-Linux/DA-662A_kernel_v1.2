...
/* $Id: spo_log_tcpdump.c,v 1.34 2003/05/19 18:08:05 chrisgreen Exp $ */
...
void LogTcpdump(Packet *p, char *msg, void *arg, Event *event)
{
    ...
    {
        /* we don't want to miss log message from portscan and other 
         * modules which don't log packet data. */
        ErrorMessage("LOG: %s\n", msg);
    }
}
