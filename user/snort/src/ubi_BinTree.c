/* ========================================================================== **
 * $Id: ubi_BinTree.c,v 1.4 2003/03/14 08:28:51 chris_reid Exp $
 *
 *                              ubi_BinTree.c
 *
 ...
 *
 * $Log: ubi_BinTree.c,v $
 * Revision 1.4  2003/03/14 08:28:51  chris_reid
 * * src/detect.c
 ...
 *
 * Revision 1.3  2002/04/01 15:35:57  andrewbaker
 *
 * * config.h needs to be includes almost everywhere
 *
 * Revision 1.2  2001/07/26 03:59:45  roesch
 * * fixed tree code for self integrity checking during traversal
 * * quiter output in some parts of Snort
 * * fixed a couple new config directives that weren't working properly
 *
