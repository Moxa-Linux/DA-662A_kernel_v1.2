...
#else
    sprintf(tmpstr,  "grep -v \"/etc/npreal2d/npreal2d.cf |");
#endif
...
#else
        sprintf(tmpstr, "cp -f /etc/config /etc/npreal2d/npreal2d.cf");
#endif
        system(tmpstr);
...
#else
    sprintf(tmpstr, "killall -15 npreal2d");
    sprintf(tmpstr, "killall -15 npreal2d_redund");
#endif
    system(tmpstr);
...
#else
        sprintf(tmpstr, "killall -9 npreal2d");
        sprintf(tmpstr, "killall -9 npreal2d_redund");
#endif
        system(tmpstr);
...
#else
    sprintf(tmpstr, "awk '$0 !~ /#/' /etc/npreal2d/npreal2d.cf |");
#endif
