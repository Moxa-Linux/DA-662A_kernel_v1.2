...
#include <arpa/inet.h>
#include <netdb.h>
#if 0 // Comment out by Jared, 2011-11-15, Not support
...
#define SUPPORT_BACKGROUND_RUN	// add by Victor Yu. 08-17-2005
int
main(int argc, char *argv[], char *env[])
{
#ifdef SUPPORT_BACKGROUND_RUN	// add by Victor Yu. 08-17-2005
	if ( fork() == 0 ) {
#endif
