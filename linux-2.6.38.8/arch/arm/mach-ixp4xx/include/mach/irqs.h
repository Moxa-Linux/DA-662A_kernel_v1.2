...
#define IRQ_MOXA_UC8000_PCI_INTA	IRQ_IXP4XX_GPIO2
#define IRQ_MOXA_UC8000_PCI_INTB	IRQ_IXP4XX_GPIO1
#define IRQ_MOXA_UC8000_PCI_INTC	IRQ_IXP4XX_GPIO0
#define IRQ_MOXA_UC8000_PCI_INTD	IRQ_IXP4XX_GPIO3

#elif defined(CONFIG_MACH_MOXA_UC8400) || defined (CONFIG_MACH_MOXA_UC8480) || defined (CONFIG_MACH_MOXA_DCU8620)	// add by Jared Wu. 06-10-2011

#define IRQ_MOXA_UC8400_PCI_INTA	IRQ_IXP4XX_GPIO0
#define IRQ_MOXA_UC8400_PCI_INTB	IRQ_IXP4XX_GPIO1
#define IRQ_MOXA_UC8400_PCI_INTC	IRQ_IXP4XX_GPIO2
#define IRQ_MOXA_UC8400_PCI_INTD	IRQ_IXP4XX_GPIO3
