...
/* Aeluin Chen, 2013-11-19. start */
#define HW_bcdUSB			0x0110
#define HUAWEI_VENDOR_ID	0x12d1
/* Aeluin Chen, 2013-11-19. end */
		   ...
		   const unsigned char *buf, int count)
{
	...
	int err;
	unsigned long flags;
	struct usb_host_endpoint *ep;	/* Aeluin Chen, 2013-11-19. */
	...
	for (i = 0; left > 0 && i < N_OUT_URB; i++) {
		...
		/* Aeluin Chen, 2013-11-19. add the judge of ZERO_PACKET - start */
		...
		/* Aeluin Chen, 2013-11-19. add the judge of ZERO_PACKET - end */
