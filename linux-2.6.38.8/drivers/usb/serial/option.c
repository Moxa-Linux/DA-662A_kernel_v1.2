...
static const struct usb_device_id option_ids[] = {
	...
	/* Aeluin Chen, 2013-11-19. add support for HUAWEI - start */
	...
	/* Aeluin Chen, 2013-11-19. add support for HUAWEI - end */
...
static struct usb_driver option_driver = {
	...
	.reset_resume   = usb_serial_resume, /* Aeluin Chen, 2013-11-19. */
			...
			const struct usb_device_id *id)
{
	...
	/* Aeluin Chen, 2013-11-19. start */
	/* Enable the selective suspend power management for HUAWEI module */
	if (serial->dev->descriptor.idVendor == HUAWEI_VENDOR_ID) {
