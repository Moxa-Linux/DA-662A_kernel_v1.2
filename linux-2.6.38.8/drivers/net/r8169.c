				 ...
				 u8 autoneg, u16 speed, u8 duplex)
{
	...
	if ((autoneg == AUTONEG_DISABLE) && (speed == SPEED_1000) &&
		...
		netif_warn(tp, link, dev, "incorrect speed setting refused in TBI mode\n");
		ret = -EOPNOTSUPP;
	}
...
#if 1	// fix it to be 10/100M, not support 1G, added by Victor Yu. 2015/6/10
...
#if 1	// added by Victor Yu. 2015/4/23
static int	cardno=0;
#endif
