...
/*15*/	{ "CP-134U series",	4, },
	{ "CP-104JU series",	4, },
    /* WADE: modify to 4 for IA241 */
	{ "Moxa UC7000 Serial",	4, },		/* RC7000 */
	{ "CP-118U series",	8, },
	{ "CP-102UL series",	2, },
/*20*/	{ "CP-102U series",	2, },
	{ "CP-118EL series",	8, },
...
static int __devinit mxser_initbrd(struct mxser_board *brd, struct pci_dev *pdev)
{
	struct mxser_port *info;
	unsigned int i;
	int retval;
	...
	retval = request_irq(brd->irq, mxser_interrupt, IRQF_SHARED, "MoxaARTSoCUART", brd);
    debug("request_irq=%d", brd->irq);
	if (retval)
